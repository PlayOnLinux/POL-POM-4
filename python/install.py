	...
	def installapp(self, event):
		...
		if(InstallApplication == "about:conceptor"):
			...
			if(playonlinux.GetSettings("FIRST_INSTALL_DONE") == ""):
				wx.MessageBox(_("When {0} install for you a Windows: \n\n - Leave the default location\n - Untick the checkbox 'Run the program' if the Windows installer asks you.").format(os.environ["APPLICATION_TITLE"]),_("Please read this"))
